...
#A number represents how many bulbs can be arround a certain block 

#In order to change the puzzle, simply change the matrix below to your desired input
matrix = [  ['E','E','E','E','-1','1','E'],
            ['2','E','E','E','E','E','E'],
            ['0','E','E','3','E','E','E'],
            ['E','E','-1','E','2','E','E'],
            ['E','E','E','3','E','E','-1'],
